  ...
  <div class="row">
    ...
    <div class="main">
      ...
      <?php foreach ($data['delivery'] as $orderDetails) : ?>
        ...
        <a href="<?php echo URLROOT ?>/Drivers/DhistoryView?order_id=<?php echo $orderDetails->order_id; ?>&seller_id=<?php echo $orderDetails->sellerID ?>" target="orderview">
    ...
    <iframe src="<?php echo URLROOT ?>/Drivers/DhistoryView?order_id=<?php echo $orderDetails->order_id; ?>&seller_id=<?php echo $orderDetails->sellerID ?>" frameborder="none" name="orderview" height="1000px" width="45%"></iframe>
  </div>
  </div>
